                        ...
                        <div class="card-body">
                            ...
                            <form id="validationform" name="docu_forms" data-parsley-validate novalidate method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 col-lg-6">
                                        <select id="dean_status" required class="form-control">
...
<script>
    $(document).ready(function() {
        ...
        $('#dean_status').on('change', function() {
        ...
        $('#edit-request').on('click', function() {
            ...
            data.append('dean_status', $('#dean_status').val());
            data.append('request_id', $('input[name=request_id]').val());

            const libraryStatus = $('#dean_status').val();
