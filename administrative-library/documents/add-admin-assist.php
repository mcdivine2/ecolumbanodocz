                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                             <h2 class="pageheader-title"><i class="fa fa-fw fa-user-lock"></i> Add Administrative Assistant </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="select-designation.php" class="breadcrumb-link">Designation</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Administrative Assistant</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="user_form" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                    <input data-parsley-type="alphanum" type="text" name="desgination" placeholder="Administrative Assistant" value="Administrative Assistant" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
   ...
   $('form[name="user_form"]').on('submit', function(e){
    ...
    if(e !=f){
     if (a === ''||  b ==='' ||  c ===''||  d ==='' ||  e ==='' ||  f ===''){
        ...
        $.ajax({
            url: '../init/controllers/add_admin_assist.php',
            method: 'post',
            data: {
              complete_name: a,
              desgination: b,
