                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="user_form" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                    <input data-parsley-type="alphanum" type="text" name="desgination" placeholder="Administrative Library" value="Administrative Library" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
   ...
   $('form[name="user_form"]').on('submit', function(e){
    ...
    if(e !=f){
     if (a === ''||  b ==='' ||  c ===''||  d ==='' ||  e ==='' ||  f ===''){
        ...
        $.ajax({
            url: '../init/controllers/add_admin_library.php',
            method: 'post',
            data: {
              complete_name: a,
              desgination: b,
