                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="docu_forms" data-parsley-validate="" novalidate="" method="POST" action="../init/controllers/email_sender.php">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input data-parsley-type="alphanum" type="text" value="Declined Request of <?= $row['document_name']; ?>" name="subject" required="" placeholder="" class="form-control" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <textarea data-parsley-type="alphanum" type="text" name="body" required="" placeholder="" class="form-control"> Hello, This is a test! Your <?= $row['document_name']; ?> has been declined! Please request again;
                                                </textarea>
