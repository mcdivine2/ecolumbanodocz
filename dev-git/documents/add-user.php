                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="user_form" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <select data-parsley-type="alphanum" type="text" name="desgination" id="desgination" required="" placeholder="" class="form-control">
                                                        
                                                           <option value="">&larr;Designation &rarr;</option>
                                                           <option value="Developer">Developer</option>
                                                           <option value="Administrator">Administrator</option>
                                                           <option value="Secretary">Secretary</option>
                                                           <option value="Assistant Aide">Assistant Aide</option>
                                                       </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
  ...
  $(document).ready(function() {
   $('form[name="user_form"]').on('submit', function(e){
      ...
      var b = $('#desgination option:selected').val();
