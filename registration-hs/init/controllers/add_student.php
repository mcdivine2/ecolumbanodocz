<?php
 ...
 function createRandomIDnumber() {
	...
	if(ISSET($_POST)){
		...
		$highschool = $conn->register($studentHSID_no, $first_name, $middle_name, $last_name, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $status, $is_highschool);
		if($highschool == TRUE){
