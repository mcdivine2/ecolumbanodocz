...
<?php
	...
	class class_model{
		...
		public function add_student($IDnumber, $first_name, $middle_name, $last_name, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $status){
			$stmt = $this->conn->prepare("INSERT INTO `tbl_high_school` (`studentHSID_no`, `first_name`, `middle_name`, `last_name`, `year_level`, `date_ofbirth`, `gender`, `complete_address`, `email_address`, `mobile_number`, `username`, `password`, `account_status`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)") or die($this->conn->error);
			$stmt->bind_param("sssssssssssss", $IDnumber, $first_name, $middle_name, $last_name, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $status);
			if($stmt->execute()){
				$stmt->close();
				$this->conn->close();
				return true;
		...
		public function register($studentHSID_no, $first_name, $middle_name, $last_name, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $status, $is_highschool){
			$stmt = $this->conn->prepare("INSERT INTO `tbl_high_school` (`studentHSID_no`, `first_name`, `middle_name`, `last_name`, `year_level`, `date_ofbirth`, `gender`, `complete_address`, `email_address`, `mobile_number`, `username`, `password`, `account_status`, `is_highschool`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)") or die($this->conn->error);
			$stmt->bind_param("ssssssssssssss", $studentHSID_no, $first_name, $middle_name, $last_name, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $status, $is_highschool);
			if($stmt->execute()){
				$stmt->close();
				$this->conn->close();
				return true;
