	...
	function createRandomIDnumber() {
		...
		$status = "Active";
			...
			$course = $conn->add_student($studentID_no, $first_name, $middle_name, $last_name, $course, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $status);
			if($course == TRUE){
